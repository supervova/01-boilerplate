...
## TODO: Настроить сборку с Vite — проконсультироваться с ChatGPT по отдельным вопросам
...
## TODO: Скрестить с SuperMark и [MVP](https://andybrewer.github.io/mvp/)

- [ ] Разделить на компоненты и собрать в `main.scss` в каскадный слой `essentials`

- [ ] Вместо build SuperMark'а — Vite или [build для npm-сборки](/notes/👨🏻‍💻 development/frontend/tools/npm-scripts) + [Сборка Pug с помощью npm](~/notes/👨🏻‍💻 development/frontend/tools/npm-scripts-pug)
